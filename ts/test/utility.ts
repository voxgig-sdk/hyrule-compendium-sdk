...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.HYRULECOMPENDIUM_TEST_LIVE ||
    'TRUE' === process.env.HYRULECOMPENDIUM_TEST_OVERRIDE
  ) {
  ...
  m.HYRULECOMPENDIUM_TEST_EXPLAIN = process.env.HYRULECOMPENDIUM_TEST_EXPLAIN || m.HYRULECOMPENDIUM_TEST_EXPLAIN
