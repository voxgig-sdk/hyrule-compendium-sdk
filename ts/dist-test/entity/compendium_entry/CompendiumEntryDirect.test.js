...
(0, node_test_1.describe)('CompendiumEntryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.HyruleCompendiumSDK({
    ...
    (0, node_test_1.test)('direct-load-compendium_entry', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-compendium_entry', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.HYRULE_COMPENDIUM_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.HyruleCompendiumSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['HYRULE_COMPENDIUM_TEST_COMPENDIUM_ENTRY_ENTID'];
    ...
    const client = new __1.HyruleCompendiumSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CompendiumEntryDirect.test.js.map