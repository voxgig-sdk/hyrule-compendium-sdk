...
(0, node_test_1.describe)('CompendiumEntryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'compendium_entry.' + op, live))
                return;
        }
        ...
        let compendium_entry_ref01_data = Object.values(setup.data.existing.compendium_entry)[0];
        // LOAD
        const compendium_entry_ref01_ent = client.CompendiumEntry();
        const compendium_entry_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(compendium_entry_ref01_data_dt0.id === compendium_entry_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/compendium_entry/CompendiumEntryTestData.json');
    ...
    let idmap = transform(['compendium_entry01', 'compendium_entry02', 'compendium_entry03', 'entry01', 'entry02', 'entry03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CompendiumEntryEntity.test.js.map