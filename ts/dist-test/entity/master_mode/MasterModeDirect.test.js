...
(0, node_test_1.describe)('MasterModeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-master_mode', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-master_mode', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["entry01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HYRULE_COMPENDIUM_TEST_MASTER_MODE_ENTID'];
...
//# sourceMappingURL=MasterModeDirect.test.js.map