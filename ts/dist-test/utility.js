...
function envOverride(m) {
    if ('TRUE' === process.env.HYRULE_COMPENDIUM_TEST_LIVE ||
        'TRUE' === process.env.HYRULE_COMPENDIUM_TEST_OVERRIDE) {
    ...
    m.HYRULE_COMPENDIUM_TEST_EXPLAIN = process.env.HYRULE_COMPENDIUM_TEST_EXPLAIN || m.HYRULE_COMPENDIUM_TEST_EXPLAIN;
    return m;
}
