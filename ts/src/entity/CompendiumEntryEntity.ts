...
class CompendiumEntryEntity extends HyruleCompendiumEntityBase<CompendiumEntry> {
  ...
  make(this: CompendiumEntryEntity) {
    return new CompendiumEntryEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: CompendiumEntryLoadMatch, ctrl?: Control): Promise<CompendiumEntryEntity> {
