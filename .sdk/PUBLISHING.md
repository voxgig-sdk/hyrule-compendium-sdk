...
|---|---|---|
| `ts/` | @voxgig-sdk/hyrule-compendium-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/hyrule-compendium-sdk \
      --repository voxgig-sdk/hyrule-compendium-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/hyrule-compendium-sdk` shows it, and
`npm trust revoke @voxgig-sdk/hyrule-compendium-sdk --id=<id>` removes it.
