...
// HyruleCompendium SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class HyruleCompendiumTransformResponse
{
    public static function call(HyruleCompendiumContext $ctx): mixed
    {
        ...
        $transform = HyruleCompendiumHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
