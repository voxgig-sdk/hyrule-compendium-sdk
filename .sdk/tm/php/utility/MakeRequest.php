...
// HyruleCompendium SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class HyruleCompendiumMakeRequest
{
    public static function call(HyruleCompendiumContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new HyruleCompendiumResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new HyruleCompendiumResponse($fetched);
        } else {
