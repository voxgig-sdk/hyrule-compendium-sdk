...
// HyruleCompendium SDK utility: make_options

class HyruleCompendiumMakeOptions
{
    ...
    public static function call(HyruleCompendiumContext $ctx): array
    {
        ...
        //
        // `HyruleCompendiumSchema::optspec()` is built from the model:
        ...
        $optspec = HyruleCompendiumSchema::optspec();
