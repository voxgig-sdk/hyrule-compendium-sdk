...
// HyruleCompendium SDK utility: result_basic

class HyruleCompendiumResultBasic
{
    public static function call(HyruleCompendiumContext $ctx): ?HyruleCompendiumResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof HyruleCompendiumError) ? $result->err->msg : (string)$result->err;
