...
// HyruleCompendium SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = HyruleCompendiumOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(HyruleCompendiumOmni::structfix($now, Struct::undef()))
                        !== json_encode(HyruleCompendiumOmni::structfix($val, Struct::undef()))) {
