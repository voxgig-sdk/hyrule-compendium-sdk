...
// HyruleCompendium SDK telemetry feature
...
class HyruleCompendiumTelemetryFeature extends HyruleCompendiumBaseFeature
{
    ...
    private function _close(HyruleCompendiumContext $ctx, bool $ok): void
    {
