...
// HyruleCompendium SDK streaming feature
...
class HyruleCompendiumStreamingFeature extends HyruleCompendiumBaseFeature
{
    ...
    private function _iterate(HyruleCompendiumResult $result): \Generator
    {
    ...
    private function _streamable(HyruleCompendiumContext $ctx): bool
    {
