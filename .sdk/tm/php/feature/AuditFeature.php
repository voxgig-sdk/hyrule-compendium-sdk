...
// HyruleCompendium SDK audit feature
...
class HyruleCompendiumAuditFeature extends HyruleCompendiumBaseFeature
{
    ...
    private function _emit(HyruleCompendiumContext $ctx, string $outcome): void
    {
