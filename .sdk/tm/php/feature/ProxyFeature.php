...
// HyruleCompendium SDK proxy feature
...
class HyruleCompendiumProxyFeature extends HyruleCompendiumBaseFeature
{
    ...
    public function init(HyruleCompendiumContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (HyruleCompendiumContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
