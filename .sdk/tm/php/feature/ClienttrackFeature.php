...
// HyruleCompendium SDK clienttrack feature
...
class HyruleCompendiumClienttrackFeature extends HyruleCompendiumBaseFeature
{
    ...
    public function PostConstruct(HyruleCompendiumContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'HyruleCompendium-SDK';
