...
// HyruleCompendium SDK ratelimit feature
...
class HyruleCompendiumRatelimitFeature extends HyruleCompendiumBaseFeature
{
    ...
    private function _acquire(HyruleCompendiumContext $ctx): void
    {
    ...
    private function _track(HyruleCompendiumContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
