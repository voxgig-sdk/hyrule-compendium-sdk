// Command HyruleCompendium-mcp is an MCP server exposing the HyruleCompendium
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HyruleCompendium_list  — list records of an entity
//	HyruleCompendium_load  — load a single record of an entity
//
