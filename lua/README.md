# HyruleCompendium Lua SDK



The Lua SDK for the HyruleCompendium API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/hyrule-compendium-sdk/releases)),
...
| `common_locations` | `table` | Common locations where this entry can be found |
...
| `drops` | `table` | Items that can be dropped by this entry |
...
```
lua/
├── hyrule-compendium_sdk.lua    -- Main SDK module
...
The main module (`hyrule-compendium_sdk`) exports the SDK constructor
