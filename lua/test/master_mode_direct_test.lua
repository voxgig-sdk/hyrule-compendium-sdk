...
describe("MasterModeDirect", function()
  it("should direct-load-master_mode", function()
    local setup = master_mode_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-master_mode", setup.live and "live" or "unit")
...
function master_mode_direct_setup(mockres)
