...
local SDK_MODULE = "hyrule-compendium_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["category"] = { ["test01"] = { id = "test01" } }, ["compendium_entry"] = { ["test01"] = { id = "test01" } }, ["master_mode"] = { ["test01"] = { id = "test01" } }, ["region"] = { ["test01"] = { id = "test01" } } } }'
