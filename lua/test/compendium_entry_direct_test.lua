...
describe("CompendiumEntryDirect", function()
  it("should direct-load-compendium_entry", function()
    local setup = compendium_entry_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-compendium_entry", setup.live and "live" or "unit")
...
function compendium_entry_direct_setup(mockres)
