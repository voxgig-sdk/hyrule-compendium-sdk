...
local MasterModeEntity = {}
MasterModeEntity.__index = MasterModeEntity


function MasterModeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MasterModeEntity)
  self._name = "master_mode"
  self._client = client
...
function MasterModeEntity:get_name()
  return self._name
end


function MasterModeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MasterModeEntity.new(self._client, opts)
end
...
function MasterModeEntity:mark_deleted()
  self._deleted = true
end


function MasterModeEntity:deleted()
  return true == self._deleted
end


function MasterModeEntity:data_set(args)
  if args ~= nil then
...
function MasterModeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MasterModeEntity:match_set(args)
  if args ~= nil then
...
function MasterModeEntity:match_get()
...
function MasterModeEntity:stream(action, args, callopts)
...
---@param reqmatch MasterModeLoadMatch
---@param ctrl? table
---@return MasterMode
---@return string? err
function MasterModeEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function MasterModeEntity:_run_op(ctx, post_done)
  local utility = self._utility
