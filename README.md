...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/hyrule-compendium` | `npm install @voxgig-sdk/hyrule-compendium` |
| Python | `voxgig-sdk-hyrule-compendium` | `pip install voxgig-sdk-hyrule-compendium` |
| PHP | `voxgig-sdk/hyrule-compendium` | `composer require voxgig-sdk/hyrule-compendium` |
| Golang | `github.com/voxgig-sdk/hyrule-compendium-sdk/go` | `go get github.com/voxgig-sdk/hyrule-compendium-sdk/go` |
| Ruby | `voxgig-sdk-hyrule-compendium` | `gem install voxgig-sdk-hyrule-compendium` |
| Lua | `voxgig-sdk-hyrule-compendium` | `luarocks install voxgig-sdk-hyrule-compendium` |
