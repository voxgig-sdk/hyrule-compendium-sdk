...
// HyruleCompendium SDK utility: graphql
//
...
class HyruleCompendiumGraphql
{
    ...
    // equivalent.
    public static function body(HyruleCompendiumContext $ctx): mixed
    {
    ...
    public static function errors(HyruleCompendiumContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
