...
// HyruleCompendium SDK utility: fetcher

class HyruleCompendiumFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HyruleCompendiumSDK/1.0)';
    ...
    public static function call(HyruleCompendiumContext $ctx, string $fullurl, array $fetchdef): array
    {
