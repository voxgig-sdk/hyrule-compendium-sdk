...
The PHP SDK for the HyruleCompendium API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Category(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->HyruleCompendium(null)->load(
    ["id" => "test01"], null
);
