...
// HyruleCompendium SDK pipeline test
//
...
{
    private static function utility(): HyruleCompendiumUtility
    {
        return new HyruleCompendiumUtility();
    }
    ...
    private static function ctx(array $over = []): HyruleCompendiumContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HyruleCompendiumContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HyruleCompendiumOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HyruleCompendiumError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HyruleCompendiumOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HyruleCompendiumMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HyruleCompendiumOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HyruleCompendiumMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HyruleCompendiumOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HyruleCompendiumMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HyruleCompendiumSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HyruleCompendiumMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HyruleCompendiumResponse([]),
            'result' => new HyruleCompendiumResult([]),
        ]);
        [, $err] = HyruleCompendiumMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HyruleCompendiumSpec([]),
            'response' => null,
            'result' => new HyruleCompendiumResult([]),
        ]);
        [, $err] = HyruleCompendiumMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HyruleCompendiumSpec(['step' => 's']),
            'response' => new HyruleCompendiumResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HyruleCompendiumResult([]),
        ]);
        [, $err] = HyruleCompendiumMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HyruleCompendiumSpec(['step' => 's']),
            'response' => new HyruleCompendiumResponse(self::resp(200, ['v' => 1])),
            'result' => new HyruleCompendiumResult([]),
        ]);
        [, $err] = HyruleCompendiumMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HyruleCompendiumSpec(['step' => 's']),
            'response' => new HyruleCompendiumResponse(self::resp(200, ['v' => 2])),
            'result' => new HyruleCompendiumResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HyruleCompendiumMakeResponse::call($ctx);
    ...
    {
        $preset = new HyruleCompendiumResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HyruleCompendiumSpec([]),
            'response' => new HyruleCompendiumResponse([]),
            'result' => new HyruleCompendiumResult([]),
        ...
        [$got, $err] = HyruleCompendiumMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HyruleCompendiumResult([])]);
        [, $err] = HyruleCompendiumMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HyruleCompendiumSpec([]), 'result' => null]);
        [, $err] = HyruleCompendiumMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HyruleCompendiumSpec(['step' => 's']),
            'result' => new HyruleCompendiumResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HyruleCompendiumOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HyruleCompendiumMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HyruleCompendiumSpec(['step' => 's']),
            'result' => new HyruleCompendiumResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HyruleCompendiumOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HyruleCompendiumMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HyruleCompendiumResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HyruleCompendiumSpec([]),
            'result' => new HyruleCompendiumResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HyruleCompendiumMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HyruleCompendiumMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HyruleCompendiumError('boom', 'boom');
        $utility->fetcher = function (HyruleCompendiumContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HyruleCompendiumSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HyruleCompendiumMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HyruleCompendiumContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HyruleCompendiumMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HyruleCompendiumResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        HyruleCompendiumMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HyruleCompendiumContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HyruleCompendiumSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HyruleCompendiumMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HyruleCompendiumResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HyruleCompendiumSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HyruleCompendiumMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HyruleCompendiumMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HyruleCompendiumMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HyruleCompendiumResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HyruleCompendiumDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HyruleCompendiumResult(['ok' => false])]);
        $this->expectException(HyruleCompendiumError::class);
        HyruleCompendiumDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HyruleCompendiumResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HyruleCompendiumMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HyruleCompendiumMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HyruleCompendiumBaseFeature();
        $b = new HyruleCompendiumBaseFeature();
        HyruleCompendiumFeatureAdd::call($ctx, $a);
        HyruleCompendiumFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HyruleCompendiumBaseFeature
    {
        $f = new HyruleCompendiumBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HyruleCompendiumFeatureAdd::call($ctx, self::named_feature('a'));
        HyruleCompendiumFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        HyruleCompendiumFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        HyruleCompendiumFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        HyruleCompendiumFeatureAdd::call($ctx, $replace);
        ...
        HyruleCompendiumFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HyruleCompendiumContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HyruleCompendiumSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HyruleCompendiumPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        HyruleCompendiumPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HyruleCompendiumResponse(['headers' => null]),
            'result' => new HyruleCompendiumResult([]),
        ]);
        HyruleCompendiumResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        HyruleCompendiumResultBody::call($ctx);
