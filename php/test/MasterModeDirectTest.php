...
class MasterModeDirectTest extends TestCase
{
    public function test_direct_load_master_mode(): void
    {
        $setup = master_mode_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-master_mode", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
