...
// HyruleCompendium SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HyruleCompendiumSDK::test)
...
{
    private const SDK_CLASS = 'HyruleCompendiumSDK';
    ...
    private const SDK_BASE = 'hyrulecompendium_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../hyrulecompendium_sdk.php';
