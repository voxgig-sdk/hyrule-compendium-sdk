...
// HyruleCompendium SDK utility type

class HyruleCompendiumUtility
{
    ...
    public static function copy(HyruleCompendiumUtility $src): HyruleCompendiumUtility
    {
        $u = new HyruleCompendiumUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
