...
// HyruleCompendium SDK Category entity
...
class CategoryEntity
{
     ...
     *
     * @param CategoryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CategoryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Category|array The loaded Category as an assoc-array at the
