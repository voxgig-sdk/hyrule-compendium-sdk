...
// HyruleCompendium SDK idempotency feature
...
class HyruleCompendiumIdempotencyFeature extends HyruleCompendiumBaseFeature
{
    ...
    private function _mutating(HyruleCompendiumContext $ctx): bool
    {
