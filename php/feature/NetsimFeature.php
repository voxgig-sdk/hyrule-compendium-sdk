...
// HyruleCompendium SDK netsim feature
...
class HyruleCompendiumNetsimFeature extends HyruleCompendiumBaseFeature
{
    ...
    private function _simulate(HyruleCompendiumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(HyruleCompendiumContext $ctx, array $applied): void
    {
        $client = $this->client;
