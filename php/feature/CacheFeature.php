...
// HyruleCompendium SDK cache feature
...
class HyruleCompendiumCacheFeature extends HyruleCompendiumBaseFeature
{
    ...
    private function _through(HyruleCompendiumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
