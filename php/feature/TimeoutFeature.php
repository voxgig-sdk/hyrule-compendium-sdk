...
// HyruleCompendium SDK timeout feature
...
class HyruleCompendiumTimeoutFeature extends HyruleCompendiumBaseFeature
{
    ...
    private function _with_timeout(HyruleCompendiumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HyruleCompendiumContext $_ctx, float $ms): void
    {
        $client = $this->client;
