...
// HyruleCompendium SDK rbac feature
...
class HyruleCompendiumRbacFeature extends HyruleCompendiumBaseFeature
{
    ...
    private function _required(HyruleCompendiumContext $ctx): ?string
    {
    ...
    private function _reject(HyruleCompendiumContext $ctx, string $required): void
    {
    ...
    private function _track(HyruleCompendiumContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
