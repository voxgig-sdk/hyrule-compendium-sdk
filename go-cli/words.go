...
func registerSDKWords(r *eng.Registry, client *sdk.HyruleCompendiumSDK) {
...
func runOp(client *sdk.HyruleCompendiumSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
