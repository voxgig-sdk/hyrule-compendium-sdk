...
AQL-driven CLI and REPL for the HyruleCompendium SDK. Positional arguments are
...
```sh
go build -o hyrule-compendium-cli ./...
```
...
./hyrule-compendium-cli list category
./hyrule-compendium-cli load 1 category
./hyrule-compendium-cli load '{id:1}' category
