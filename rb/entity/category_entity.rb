...
class CategoryEntity
  ...
  #
  # @param reqmatch [CategoryLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Category.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Category, Hash] the loaded Category; raises HyruleCompendiumError on failure
