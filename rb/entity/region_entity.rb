...
class RegionEntity
  ...
  #
  # @param reqmatch [RegionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Region.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Region, Hash] the loaded Region; raises HyruleCompendiumError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Region>, Array] the matching Region items; raises HyruleCompendiumError on failure
