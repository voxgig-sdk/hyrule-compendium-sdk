...
#      offline in seeded test mode (HyruleCompendiumSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "HyruleCompendium_sdk.rb")
  SDK_CLASS = "HyruleCompendiumSDK"
