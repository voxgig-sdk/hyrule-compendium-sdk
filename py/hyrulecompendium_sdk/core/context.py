...
from hyrulecompendium_sdk.core.control import HyruleCompendiumControl
...
from hyrulecompendium_sdk.core.helpers import get_ctx_prop, to_map
...
class HyruleCompendiumContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = HyruleCompendiumControl()
        ...
        if isinstance(sp, HyruleCompendiumSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, HyruleCompendiumResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, HyruleCompendiumResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return HyruleCompendiumOperation({})
    ...
    def make_error(self, code, msg):
        return HyruleCompendiumError(code, msg, self)
