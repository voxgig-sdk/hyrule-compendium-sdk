...
from hyrulecompendium_sdk.utility import register

# Load features
from hyrulecompendium_sdk.feature.base_feature import HyruleCompendiumBaseFeature
from hyrulecompendium_sdk.features import _has_feature, _make_feature
...
class HyruleCompendiumSDK:
    ...
    def get_utility(self):
        return HyruleCompendiumUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("HyruleCompendiumSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Category(self, data=None) -> "CategoryEntity":
        ...
        from hyrulecompendium_sdk.entity.category_entity import CategoryEntity
    ...
    def CompendiumEntry(self, data=None) -> "CompendiumEntryEntity":
        ...
        from hyrulecompendium_sdk.entity.compendium_entry_entity import CompendiumEntryEntity
    ...
    def MasterMode(self, data=None) -> "MasterModeEntity":
        ...
        from hyrulecompendium_sdk.entity.master_mode_entity import MasterModeEntity
    ...
    def Region(self, data=None) -> "RegionEntity":
        ...
        from hyrulecompendium_sdk.entity.region_entity import RegionEntity
