...
from hyrulecompendium_sdk.hyrulecompendium_types import (
    CompendiumEntry,
...
class CompendiumEntryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CompendiumEntryEntity(self._client, opts)
    ...
    def data_get(self) -> CompendiumEntry:
    ...
    def match_get(self) -> CompendiumEntry:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CompendiumEntry:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CompendiumEntry().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
