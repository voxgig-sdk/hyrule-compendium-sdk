# HyruleCompendium SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HyruleCompendiumSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HyruleCompendiumSDK(...) and HyruleCompendiumSDK.test(...) become
#      HyruleCompendiumSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "hyrulecompendium_sdk"
_SDK_CLASS = "HyruleCompendiumSDK"
...
_ENTITIES = {
    "Category": "category",
    "CompendiumEntry": "compendium_entry",
