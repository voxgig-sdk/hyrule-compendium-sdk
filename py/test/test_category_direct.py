...
class TestCategoryDirect:
    ...
    def test_should_direct_load_category(self):
        setup = _category_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-category", "live" if setup["live"] else "unit")
        if _skip:
