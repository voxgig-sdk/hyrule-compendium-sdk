...
const testSeed = `map[string]any{"entity": map[string]any{"category": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "compendium_entry": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "master_mode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "region": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
