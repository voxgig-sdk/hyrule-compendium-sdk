...
func NewMasterModeEntity(client *core.HyruleCompendiumSDK, entopts map[string]any) *MasterModeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MasterModeEntity) GetName() string { return e.name }
...
func (e *MasterModeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MasterModeEntity) Deleted() bool {
	return e.deleted
}


func (e *MasterModeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMasterModeEntity(e.client, opts)
}

func (e *MasterModeEntity) Data(args ...any) any {
...
func (e *MasterModeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MasterMode; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MasterModeEntity) DataTyped(data ...MasterMode) MasterMode {
	if len(data) > 0 {
		return typedFrom[MasterMode](e.Data(asMap(data[0])))
	}
	return typedFrom[MasterMode](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MasterMode (all fields
// optional at the wire level).
func (e *MasterModeEntity) MatchTyped(match ...MasterMode) MasterMode {
	if len(match) > 0 {
		return typedFrom[MasterMode](e.Match(asMap(match[0])))
	}
	return typedFrom[MasterMode](e.Match())
}
...
func (e *MasterModeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MasterModeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MasterModeLoadMatch and returns an MasterMode. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MasterModeEntity) LoadTyped(reqmatch MasterModeLoadMatch, ctrl map[string]any) (MasterMode, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return MasterMode{}, err
	}
	return typedFrom[MasterMode](res), nil
}



func (e *MasterModeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MasterModeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MasterModeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MasterModeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MasterModeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
