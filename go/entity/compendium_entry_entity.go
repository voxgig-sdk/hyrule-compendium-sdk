...
type CompendiumEntryEntity struct {
	name    string
	client  *core.HyruleCompendiumSDK
...
func NewCompendiumEntryEntity(client *core.HyruleCompendiumSDK, entopts map[string]any) *CompendiumEntryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CompendiumEntryEntity) GetName() string { return e.name }
...
func (e *CompendiumEntryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CompendiumEntryEntity) Deleted() bool {
	return e.deleted
}


func (e *CompendiumEntryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCompendiumEntryEntity(e.client, opts)
}

func (e *CompendiumEntryEntity) Data(args ...any) any {
...
func (e *CompendiumEntryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CompendiumEntry; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CompendiumEntryEntity) DataTyped(data ...CompendiumEntry) CompendiumEntry {
	if len(data) > 0 {
		return typedFrom[CompendiumEntry](e.Data(asMap(data[0])))
	}
	return typedFrom[CompendiumEntry](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CompendiumEntry (all fields
// optional at the wire level).
func (e *CompendiumEntryEntity) MatchTyped(match ...CompendiumEntry) CompendiumEntry {
	if len(match) > 0 {
		return typedFrom[CompendiumEntry](e.Match(asMap(match[0])))
	}
	return typedFrom[CompendiumEntry](e.Match())
}
...
func (e *CompendiumEntryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CompendiumEntryEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CompendiumEntryLoadMatch and returns an CompendiumEntry. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CompendiumEntryEntity) LoadTyped(reqmatch CompendiumEntryLoadMatch, ctrl map[string]any) (CompendiumEntry, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CompendiumEntry{}, err
	}
	return typedFrom[CompendiumEntry](res), nil
}



func (e *CompendiumEntryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CompendiumEntryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CompendiumEntryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CompendiumEntryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CompendiumEntryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
