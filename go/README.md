# HyruleCompendium Golang SDK



The Golang SDK for the HyruleCompendium API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/hyrule-compendium-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/hyrule-compendium-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/hyrule-compendium-sdk/go=../hyrule-compendium-sdk/go
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *HyruleCompendiumSDK
```
...
| `Category` | `(data map[string]any) HyruleCompendiumEntity` | Create a Category entity instance. |
| `CompendiumEntry` | `(data map[string]any) HyruleCompendiumEntity` | Create a CompendiumEntry entity instance. |
| `MasterMode` | `(data map[string]any) HyruleCompendiumEntity` | Create a MasterMode entity instance. |
| `Region` | `(data map[string]any) HyruleCompendiumEntity` | Create a Region entity instance. |

### Entity interface (HyruleCompendiumEntity)

All entities implement the `HyruleCompendiumEntity` interface.
...
```
github.com/voxgig-sdk/hyrule-compendium-sdk/go/
├── hyrule-compendium.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/hyrule-compendium-sdk/go`) re-exports everything needed
