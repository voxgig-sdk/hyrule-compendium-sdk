...
type HyruleCompendiumSDK struct {
	Mode     string
...
func (sdk *HyruleCompendiumSDK) OptionsMap() map[string]any {
...
func (sdk *HyruleCompendiumSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *HyruleCompendiumSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *HyruleCompendiumSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HyruleCompendiumSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *HyruleCompendiumSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *HyruleCompendiumSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("HyruleCompendiumSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *HyruleCompendiumSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HyruleCompendiumSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("HyruleCompendiumSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *HyruleCompendiumSDK {
	...
	sdk := NewHyruleCompendiumSDK(sdkopts)
	sdk.Mode = "test"
