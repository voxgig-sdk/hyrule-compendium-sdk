...
// instead of `sdk.NewHyruleCompendiumSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *HyruleCompendiumSDK  { return NewHyruleCompendiumSDK(nil) }
func Test() *HyruleCompendiumSDK { return TestSDK(nil, nil) }
